    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mShaker.setOnShakeListener(new ShakeListener.OnShakeListener () {
            public void onShake()
            {
                ...
                Intent bVR = new Intent("com.ShakeItTakeIt.ShowJSON");
                finish();
                startActivity(bVR);
    ...
    public void onClick(View arg0) {
        switch (arg0.getId()) {
            ...
            case R.id.bShare:
                ...
                share.putExtra(Intent.EXTRA_TEXT, "Try Shake It Take it. It really helps with decision making. https://notendur.hi.is/sij65/Hugbunadarverkefni%201/App/ShakeItTakeIt.apk");
